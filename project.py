...
CLIENT_SECRET_FILE_NAME = 'client_secret_989899533517-a24gggrpsg9jqn2ouqqabmohc3hbq13u.apps.googleusercontent.com.json'
CLIENT_ID = json.loads(
    open(CLIENT_SECRET_FILE_NAME, 'r')
    .read())['web']['client_id']
...
# The token is stored in the session for later validation
@app.route('/login')
def showLogin():
...
def editRestaurant(restaurant_id):
  ...
  if editedRestaurant.user_id != login_session['user_id']:
    flash('You are not authorized for this operation!')
